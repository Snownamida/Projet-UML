...
int main() {
  ...
  for (int i = 0; i < sensorContainer.getSensors().size(); i++) {
    ...
    for (int j = 0;
         j < sensorContainer.getSensors()[i].getMeasurmentsO3().size(); j++) {
      indiceO3 +=
          sensorContainer.getSensors()[i].getMeasurmentsO3()[j].getValue();
      counterO3++;
    }
    for (int j = 0;
         j < sensorContainer.getSensors()[i].getMeasurmentsSO2().size(); j++) {
      indiceSO2 +=
          sensorContainer.getSensors()[i].getMeasurmentsSO2()[j].getValue();
      counterSO2++;
    }
    for (int j = 0;
         j < sensorContainer.getSensors()[i].getMeasurmentsPM10().size(); j++) {
      indicePM10 +=
          sensorContainer.getSensors()[i].getMeasurmentsPM10()[j].getValue();
      counterPM10++;
    }
    for (int j = 0;
         j < sensorContainer.getSensors()[i].getMeasurmentsNO2().size(); j++) {
      indiceNO2 +=
          sensorContainer.getSensors()[i].getMeasurmentsNO2()[j].getValue();
      counterNO2++;
    }
  }
